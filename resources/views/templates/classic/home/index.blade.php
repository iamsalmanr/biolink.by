                    ...
                    <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
                        <div>
                            <h1 class="display-1 sm-font-50 md-font-60 mb-24 fw-bold text-white">
                                {{ ___('Your Link in Seconds')  }}
                            </h1>
                            <p class="lead font-18 mb-24 text-light-3">{{ ___("Join 99+ influencers and create a MyLink page to grow your followers across all social networks.")  }}</p>
                        </div>
                        <div class="d-flex justify-content-center " data-cues="slideInDown" data-delay="600">
                            <div class="position-relative">
                                <a href="{{ route('register') }}" class="button -primary h-48-px transform-none"><i class="fa-solid fa-stars mr-5"></i> {{ ___('Try Now')  }}
                                </a>
                            </div>
                        </div>
                        <!-- /div -->
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="max-w-6xl mx-auto text-center aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
                <h2 class="mt-2 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-blue-600">
                    Create your MyLink in 5 minutes on mobile!
                </h2>
                <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">
                    Register for free, build and manage your MyLinks anywhere, anytime, on the go — without limits.
                </p>
            </div>
            ...
            <div class="relative mt-12 lg:mt-20">
                ...
                <div class="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                    ...
                    <div class="aos-init aos-animate" data-aos="zoom-in" data-aos-duration="1200">
                        ...
                        <h3 class="mt-6 text-xl font-semibold leading-tight text-black md:mt-10">Get your MyLink</h3>
                        <p class="mt-4 text-base text-gray-600">
                            Create a free account and choose a personalized MyLinks URL to maintain your brand identity.
                        </p>
                    </div>
                    ...
                    <div class="aos-init aos-animate" data-aos="zoom-in" data-aos-duration="1200" data-aos-delay="600">
                        ...
                        <p class="mt-4 text-base text-gray-600">
                            Share your MyLinks page across all your social profiles, making it easy for users to find and follow you everywhere.
                        </p>
                    </div>
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-2xl mx-auto text-center">
                    ...
                    <h2 class="text-4xl font-bold text-gray-900 font-pj aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200">
                        Join ⚡️ MyLink community
                    </h2>
                    <p class="max-w-md mx-auto mt-5 text-base font-normal text-gray-600 font-pj aos-init aos-animate" 
                    data-aos="fade-up" data-aos-duration="1200">
                        Become a MyLink fan! We've built a tool that helps you achieve your goals and grow your social community using the best Bio Link tool on the market.
                    </p>
                </div>
