...
<section class="hero-wrapper -style2">
    <div class="bg-black overflow-hidden">
        <div class="pt-180 pb-180 lg-pb-120 text-center position-relative">
            <img src="{{ asset($activeThemeAssets.'assets/images/shape/spider-web-hero-bg.webp') }}" class="hero-bg-overlay-image position-absolute opacity-10">
            <div class="row position-relative mb-100 md-mb-0 lg-mb-30 px-20">
                <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
                    <div>
                        <h1 class="display-1 sm-font-50 md-font-60 mb-24 fw-bold">
                            <span class="text-gradient" style="background: linear-gradient(90deg, #ff4d4d, #4d94ff, #00ffcc); 
                        ...
                        <p class="lead font-18 mb-24 text-light-3">
                            {{ ___("Make everything you promote on social searchable to help your followers find exactly what they're looking for. It’s easier than you think.") }}
                        </p>
                    </div>
                    <div class="d-flex justify-content-center flex-column align-items-center" data-cues="slideInDown" data-delay="600">
                        <div class="position-relative d-flex align-items-center">
                            <span class="font-18 text-white mr-10">biolink.by</span>
                            <input 
                                type="text" 
                                placeholder="username" 
                                class="form-control h-48-px px-20" 
                                style="outline: 2px solid rgba(255, 255, 255, 0.5); 
                                    border: none; 
                                    border-radius: 5px; 
                        ...
                        <a href="{{ route('register') }}" class="button -primary h-48-px transform-none mt-20">
                            <i class="fa-solid fa-stars mr-5"></i> {{ ___('Get Started') }}
                        </a>
                    </div>
                </div>
                <!-- /column -->
